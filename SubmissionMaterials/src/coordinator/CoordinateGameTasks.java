...
public class CoordinateGameTasks extends UnicastRemoteObject implements CoordinateGame {
    ...
    private static Integer winCondition = 10; //change wincondition here
    private static Integer minPlayers = 4; // change minimum players to start game here
    ...
    public void populate() {
        try (BufferedReader br = new BufferedReader(new InputStreamReader(
                this.getClass().getResourceAsStream("/coordinator/questions.txt")))) {
            String line;
    ...
    static class VoteThread extends Thread {
        ...
        public void run() {
            try {
                ...
                System.out.println("Remote Exception getting votes");
            }
        }
    }
